...
static const char *palettes[][20] = {
    ...
    {"#504c4a", "#cc241d", "#98971a", "#d79921", "#458588", "#b16286", "#689d6a", "#7c6f64",
     "#3c3836", "#9d0006", "#79740e", "#b57614", "#076678", "#8f3f71", "#427b58", "#928374",
     "#f2e5bc", "#3c3836", "#3c3836", "#f2e5bc"},
    /* nord light */
    {"#10192B", "#8C2E37", "#708B59", "#B89858", "#2B4E79", "#815B7A", "#558D9D", "#B2B6BD",
     "#060F21", "#96242D", "#66954F", "#C2A24E", "#214483", "#8B5184", "#4B97A7", "#BCC0C7",

...
static const char *palettes[][20] = {
    ...
    {"#414868", "#f7768e", "#73daca", "#e0af68", "#7aa2f7", "#bb9af7", "#7dcfff", "#c0caf5",
     ...
     "#000000", "#a9b1d6", "#cccccc", "#1a1b26"},
    /* one dark */
    {"#4b5263", "#e06c75", "#98c379", "#e5c07b", "#61afef", "#c678dd", "#56b6c2", "#828997",
     "#3e4452", "#ea626b", "#8ecd6f", "#efca71", "#57a5f9", "#d06ee7", "#4cc0cc", "#8c93a1",
    ...
    /* slayer */
    {"#661919", "#991919", "#669900", "#999900", "#663366", "#993366", "#996666", "#cc6666",
     "#661919", "#991919", "#669900", "#999900", "#663366", "#993366", "#996666", "#cc6666",
     "#190000", "#a80000", "#cc0000", "#190000"},
    /* idfk */
    {"#306030", "#A09050", "#30CC50", "#B0CC60", "#6090A0", "#B090B0", "#40CCA0", "#A0CCA0",
     "#447444", "#B4A464", "#44E064", "#C4E074", "#74A4B4", "#C4A4C4", "#54E0B4", "#B4E0B4",
     "#003430", "#B0D0B0", "#88CC88", "#40cc40"},
    /* gruvbox */
    {"#504c4a", "#cc241d", "#98971a", "#d79921", "#458588", "#b16286", "#689d6a", "#a89984",
     "#928374", "#fb4934", "#b8bb26", "#fabd2f", "#83a598", "#d3869b", "#8ec07c", "#ebdbb2",
     "#32302f", "#ebdbb2", "#ebdbb2", "#32302f"},
    /* gruvbox light */
    {"#7c6f64", "#cc241d", "#98971a", "#d79921", "#458588", "#b16286", "#689d6a", "#504c4a",
     "#928374", "#9d0006", "#79740e", "#b57614", "#076678", "#8f3f71", "#427b58", "#3c3836",
     "#f2e5bc", "#3c3836", "#3c3836", "#f2e5bc"},
    /* nord light */
    {"#B2B6BD", "#8C2E37", "#708B59", "#B89858", "#2B4E79", "#815B7A", "#558D9D", "#10192B",
     "#BCC0C7", "#96242D", "#66954F", "#C2A24E", "#214483", "#8B5184", "#4B97A7", "#060F21",
     "#D8DEE9", "#2E3440", "#4C566A", "#D8DEE9"},
};
